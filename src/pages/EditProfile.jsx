      ...
      <div className="px-5 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-neutral-400 mb-3">
            Upload a fallback cover image. If you set a Featured portfolio item, it will instantly replace this preview. Changes publish when you tap "Save Profile". (Only accepts webp format)
          </p>
          {coverImageError && (
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-neutral-400 mb-3">
            Upload a clear photo of yourself. This appears as a small circular image on your profile, messages, and reviews. (Only accepts webp format)
          </p>
          <label className="relative cursor-pointer block">
